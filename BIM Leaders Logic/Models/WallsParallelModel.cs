...
namespace BIM_Leaders_Logic
{
    ...
    public class WallsParallelModel : BaseModel
    {
        ...
        private protected override void TryExecute()
        {
            ...
            using (Transaction trans = new Transaction(Doc, TransactionName))
            {
                ...
                {
                    Element filter = ViewFilterUtils.CreateSelectionFilter(Doc, FILTER_NAME, wallsToFilter);
        ...
        {
            ReferencePlane referencePlane = Doc.GetElement(new ElementId(SelectedElement)) as ReferencePlane;
