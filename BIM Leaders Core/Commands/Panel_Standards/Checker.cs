    ...
    public class Checker : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            try
            {
                ...
                string inputPrefix = data.result_prefix;
                List<bool> inputCategories = data.result_categories;
                List<bool> inputModel = data.result_model;
                List<bool> inputCodes = data.result_codes;
                int inputHeadHeight = data.result_height;
                ...
                using (Transaction trans = new Transaction(doc, "Check"))
                {
                    ...
                    if (inputCodes[1])
                    {
                        ...
                        // Show result
                        Checker_Report_Data dataReport = new Checker_Report_Data(reportDataSet);
                        Checker_Report_Form formReport = new Checker_Report_Form(reportDataSet);
