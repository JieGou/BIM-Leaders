...
namespace BIM_Leaders_Windows
{
    ...
    /// </summary>
    public class WallsCompareData : INotifyPropertyChanged
    {
        UIDocument Uidoc = null;
        public string Error { get { return null; } }
        /// <summary>
        /// Default constructor
        /// Initializing a new instance of the <see cref="WallsCompareData"/> class.
        /// </summary>

        public WallsCompareData(UIDocument uidoc)
        {
            Uidoc = uidoc;
            ResultLinks = true;
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating picked side for <see cref="LevelsAlignData"/> annotations.
        /// </summary>
        /// /// <value>
